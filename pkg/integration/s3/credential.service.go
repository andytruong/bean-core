...
func (srv *credentialService) load(ctx context.Context, appId string) (*model.Credentials, error) {
	var (
		err      error
...
func (srv *credentialService) save(ctx context.Context, in dto.S3ApplicationCredentialsInput) (*model.Credentials, error) {
	var (
		err    error
		bucket *configModel.ConfigBucket
	)
